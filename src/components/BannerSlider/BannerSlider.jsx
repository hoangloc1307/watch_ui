    ...
    return (
        ...
        >
            ...
            <div
                ...
                className="absolute top-1/2 left-0 right-0 -translate-y-1/2 z-10 flex justify-between p-2 pointer-events-none"
            >
                <button
                    ref={refPrevButton}
                    className="text-lg flex items-center justify-center p-1 rounded-full bg-primary opacity-20 text-white pointer-events-auto active:opacity-60"
                >
